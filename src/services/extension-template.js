...
export async function instantiateExtensionTemplate(
  localTemplatePath,
  context,
  opts,
) {
  ...
  if (!context.extensionPath) {
    throw new Error(
      `Missing extension path for extension-template ${localTemplatePath}`,
    );
  }
  ...
  return await template.instantiateTemplatePath(
    'extension-js',
    context.extensionPath,
    context,
    opts,
