  ...
  return yargs
    .options({
      nobuild: {
        type: 'boolean',
        description:
          'Pushes and publishes the extension without building it. Use this option carefully!',
      },
      nopush: {
        type: 'boolean',
        description:
          'Publishes the extension without pushing it first. Use this option carefully!',
      },
    })
...
export async function handler(args) {
  if (
    !(await confirmPublish(
      "WARNING: You are about to publish using the 'shoutem' developer account. Are you sure about that?",
    ))
  ) {
