...
describe('Auth service client integration tests', () => {
  describe('Create a refresh token', () => {
    ...
    it('should report invalid credentials', async () => {
      ...
      throw new Error(
        '401 error should have been reported by the shoutem api when invalid password is used',
      );
    });
    ...
    it('should create an app token', async () => {
      ...
      const appToken = await authService.createAppAccessToken(
        3777,
        refreshToken,
      );
